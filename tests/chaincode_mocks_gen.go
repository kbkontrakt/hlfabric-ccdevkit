...
//go:generate mockgen -self_package=github.com/kbkontrakt/hlfabric-ccdevkit/tests -source=../vendor/github.com/hyperledger/fabric/core/chaincode/shim/interfaces.go -package=tests -destination=chaincode_mocks.go
